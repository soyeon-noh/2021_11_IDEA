...
public class NaverConnection {
    ...
    private final static String CLIENT_ID = "2_navuVwHOcS2bJ5WUHC";
//    private final static String CLIENT_ID = "YOUR NAVER CLIENT ID";
    private final static String CLIENT_SECRET = "iWiB0jCJDe";
//    private final static String CLIENT_SECRET = "YOUR NAVER CLIENT SECRET";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        PrintWriter out = new PrintWriter(saveFile); // Exception 처리
